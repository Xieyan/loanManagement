<?php 
	...
	$selectsql = "select status from forms where id = '$id'";
	...
	<body>
		...
		<div class="container">
			<div class=' row col-md-6 col-md-offset-2 custyle'>
				<h1> Form Status Edit </h1>
				<br/>
			</div>
		    <div class="row col-md-7 col-md-offset-2 custyle">
				<form class="form-horizontal" method = "post" action = "manager.formstatus.handle.php" >
					...
					<a href="manager.index.php" class='btn btn-danger'> Back To Admin Page </a> 
